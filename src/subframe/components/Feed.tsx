...
/*
 * Documentation:
 * Feed — https://app.subframe.com/0404b3bb1ee2/library?component=Feed_7d554e3e-c194-4acf-8d18-5fba3a57892f
 * Icon with background — https://app.subframe.com/0404b3bb1ee2/library?component=Icon+with+background_c5d68c0e-4c0c-4cff-8d8c-6ff334859b3a
...
const Comment = React.forwardRef<HTMLElement, CommentProps>(function Comment(
  ...
  return (
    <div
      className={SubframeCore.twClassNames(
        "flex max-w-[576px] flex-col items-start gap-2 rounded-lg bg-neutral-50 pt-2 pr-4 pb-2 pl-4",
        className
      )}
      ref={ref as any}
      {...otherProps}
