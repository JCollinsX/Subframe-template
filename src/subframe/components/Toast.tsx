...
/*
 * Documentation:
 * Toast — https://app.subframe.com/0404b3bb1ee2/library?component=Toast_2c7966c2-a95d-468a-83fe-bf196b95be7a
    ...
    return (
      <div
        className={SubframeCore.twClassNames(
          "group/2c7966c2 flex w-80 items-center gap-4 rounded-lg bg-default-background pt-3 pr-4 pb-3 pl-4 shadow-overlay",
          className
        )}
        ref={ref as any}
        {...otherProps}
