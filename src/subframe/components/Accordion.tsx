...
/*
 * Documentation:
 * Accordion — https://app.subframe.com/0404b3bb1ee2/library?component=Accordion_d2e81e20-863a-4027-826a-991d8910efd9
 */
  ...
  function AccordionRoot(
    ...
    return (
      <SubframeCore.Collapsible.Root asChild={true} {...otherProps}>
        <div
          className={SubframeCore.twClassNames(
            "group/d2e81e20 flex w-full flex-col items-start rounded-lg",
            className
          )}
          ref={ref as any}
        >
