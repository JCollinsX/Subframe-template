...
/*
 * Documentation:
 * Tree View — https://app.subframe.com/0404b3bb1ee2/library?component=Tree+View_4ed46422-ecc3-41e8-8787-e55ee10cdc75
 */
...
const Folder = React.forwardRef<HTMLElement, FolderProps>(function Folder(
  ...
  return (
    <Accordion
      ...
      trigger={
        <div className="flex w-full items-center gap-2 rounded-lg pt-2 pr-3 pb-2 pl-3 group-hover/c841484c:bg-neutral-50">
          <SubframeCore.Icon
...
const Item = React.forwardRef<HTMLElement, ItemProps>(function Item(
  ...
  return (
    <div
      className={SubframeCore.twClassNames(
        "group/42786044 flex w-full cursor-pointer items-center gap-2 rounded-lg pt-2 pr-3 pb-2 pl-3 hover:bg-neutral-50",
