...
/*
 * Documentation:
 * Navbar — https://app.subframe.com/0404b3bb1ee2/library?component=Navbar_6ca1b963-718d-4d67-aada-b3a747fd3661
 */
  ...
  return (
    <div
      className={SubframeCore.twClassNames(
        "group/bb245e2d flex cursor-pointer flex-col items-start gap-2 rounded-lg pt-2 pr-3 pb-2 pl-3 hover:bg-neutral-50 active:bg-neutral-100",
