...
/*
 * Documentation:
 * Select — https://app.subframe.com/0404b3bb1ee2/library?component=Select_bb88f90b-8c43-4b73-9c2f-3558ce7838f3
 */
    ...
    <SubframeCore.Select.Item value={value} asChild={true} {...otherProps}>
      <div
        className={SubframeCore.twClassNames(
          "group/969e345b flex h-8 w-full cursor-pointer items-center gap-1 rounded-lg pr-3 pl-3 hover:bg-neutral-100 active:bg-neutral-50 data-[highlighted]:bg-brand-50",
          className
        )}
        ref={ref as any}
      >
...
const Content = React.forwardRef<HTMLElement, ContentProps>(function Content(
  ...
  return children ? (
    <SubframeCore.Select.Content asChild={true} {...otherProps}>
      <div
        className={SubframeCore.twClassNames(
          "flex w-full flex-col items-start overflow-hidden rounded-lg border border-solid border-neutral-border bg-white pt-1 pr-1 pb-1 pl-1 shadow-overlay",
          className
        )}
        ref={ref as any}
      >
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={SubframeCore.twClassNames(
              "flex h-8 w-full flex-none flex-col items-start rounded-lg border border-solid border-neutral-border bg-default-background group-focus-within/bb88f90b:border group-focus-within/bb88f90b:border-solid group-focus-within/bb88f90b:border-brand-primary",
              {
