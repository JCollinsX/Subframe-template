...
/*
 * Documentation:
 * Dialog — https://app.subframe.com/0404b3bb1ee2/library?component=Dialog_ca59db17-43fb-4247-8094-3c55162e902d
    ...
    <SubframeCore.Dialog.Content asChild={true} {...otherProps}>
      <div
        className={SubframeCore.twClassNames(
          "flex min-w-[320px] flex-col items-start gap-2 rounded-lg border border-solid border-neutral-border bg-default-background shadow-overlay",
          className
        )}
        ref={ref as any}
      >
