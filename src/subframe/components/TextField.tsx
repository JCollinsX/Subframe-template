  ...
  function TextFieldRoot(
    ...
    return (
      ...
      >
        ...
        <div
          className={SubframeCore.twClassNames(
            "flex h-8 w-full flex-none items-center gap-1 rounded-lg border border-solid border-neutral-border bg-default-background pr-2 pl-2 group-focus-within/be48ca43:border group-focus-within/be48ca43:border-solid group-focus-within/be48ca43:border-brand-primary",
            {
