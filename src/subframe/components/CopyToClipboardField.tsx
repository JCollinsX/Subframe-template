...
/*
 * Documentation:
 * Copy to clipboard field — https://app.subframe.com/0404b3bb1ee2/library?component=Copy+to+clipboard+field_1e2e1a38-8b4a-41bd-b224-b893c92a0495
 * Copy to clipboard button — https://app.subframe.com/0404b3bb1ee2/library?component=Copy+to+clipboard+button_e8c76626-6462-4f2f-b595-38d530d427e8
 */
  ...
  return (
    <div
      className={SubframeCore.twClassNames(
        "flex items-start gap-1.5 rounded-lg border border-solid border-neutral-border bg-neutral-50 pt-0.5 pr-0.5 pb-0.5 pl-2",
        className
      )}
      ref={ref as any}
      {...otherProps}
