...
/*
 * Documentation:
 * Payment Method Row — https://app.subframe.com/0404b3bb1ee2/library?component=Payment+Method+Row_ebe0e1ae-b362-4943-a271-a4bde71d1d5c
  ...
  return (
    <div
      className={SubframeCore.twClassNames(
        "group/ebe0e1ae flex w-full items-center gap-4 rounded-lg bg-neutral-50 pt-4 pr-4 pb-4 pl-4",
        className
      )}
      ref={ref as any}
      {...otherProps}
