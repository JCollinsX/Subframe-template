...
/*
 * Documentation:
 * Pricing Plan Card — https://app.subframe.com/0404b3bb1ee2/library?component=Pricing+Plan+Card_0f90e6c8-dfbe-4079-8903-30f237bd215d
...
>(function PricingPlanCardRoot(
  ...
  return (
    <div
      className={SubframeCore.twClassNames(
        "flex h-full w-full min-w-[128px] max-w-[384px] flex-col items-start gap-8 rounded-lg border border-solid border-neutral-border bg-default-background pt-6 pr-6 pb-6 pl-6 shadow-default",
        className
      )}
      ref={ref as any}
      {...otherProps}
