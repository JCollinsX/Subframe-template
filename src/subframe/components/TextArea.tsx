...
/*
 * Documentation:
 * Text Area — https://app.subframe.com/0404b3bb1ee2/library?component=Text+Area_4ec05ee8-8f1c-46b2-b863-5419aa7f5cce
 */
    ...
    return (
      ...
      >
        ...
        {children ? (
          <div
            className={SubframeCore.twClassNames(
              "flex w-full grow shrink-0 basis-0 flex-col items-start rounded-lg border border-solid border-neutral-border bg-default-background pl-1 group-focus-within/4ec05ee8:border group-focus-within/4ec05ee8:border-solid group-focus-within/4ec05ee8:border-brand-primary",
              {
