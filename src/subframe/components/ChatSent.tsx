...
/*
 * Documentation:
 * Chat Sent — https://app.subframe.com/0404b3bb1ee2/library?component=Chat+Sent_8206bfc1-a590-434f-9706-c81a8bc60827
 */
    ...
    return (
      ...
      >
        <div className="flex flex-col items-start justify-center gap-1">
          ...
          <div className="flex w-full max-w-[576px] flex-col items-start gap-2 rounded-lg bg-brand-600 pt-2 pr-3 pb-2 pl-3">
            {message ? (
