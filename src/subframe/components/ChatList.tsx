...
/*
 * Documentation:
 * Chat List — https://app.subframe.com/0404b3bb1ee2/library?component=Chat+List_0912e9e6-c7c3-497f-bf60-cb5361d8c378
 */
    ...
    return (
      <div
        className={SubframeCore.twClassNames(
          "group/f0df7a36 flex w-full cursor-pointer items-center gap-4 overflow-hidden rounded-lg pt-3 pr-3 pb-3 pl-3 hover:bg-neutral-50 active:bg-neutral-100",
