...
/*
 * Documentation:
 * Skeleton Text — https://app.subframe.com/0404b3bb1ee2/library?component=Skeleton+Text_a9aae3f0-955e-4607-a272-374f1dc18f4b
 */
    ...
    return (
      <SubframeCore.Skeleton
        className={SubframeCore.twClassNames(
          "group/a9aae3f0 flex h-5 w-full flex-col items-start gap-2 rounded-lg bg-neutral-200",
          {
